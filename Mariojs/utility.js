...
function updatePosition(me) {
  ...
  if(!me.nomove) shiftHoriz(me, me.player || me.group === "enemy" || me.group === "item" || me.type === "player" ? me.xvel * 1.25 : me.xvel);
...
function characterOnSolid(me, solid) {
  var xvel = me.player || me.group === "enemy" || me.group === "item" || me.type === "player" ? me.xvel * 1.25 : me.xvel;
  return (me.resting == solid || (objectOnSolid(me, solid) && me.yvel >= 0 &&
    me.left + xvel + unitsize != solid.right && me.right - xvel - unitsize != solid.left));
}
...
function moveSmart(me) {
  ...
  if(me.group !== "item" && me.yvel == 0 && (!me.resting || (offResting(me)))) {
